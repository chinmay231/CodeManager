...
class _BatchingHandler(FileSystemEventHandler):
    def __init__(self, root: Path, exclude_dirs, exclude_file_regexes, debounce_ms, on_batch):
        self.root = Path(root)
...
class DirectoryWatcher:
    def __init__(self, root: Path, exclude_dirs=None, exclude_file_regexes=None, debounce_ms: int = 400, on_batch=None):
        self.root = Path(root)
